                    ...
                    <div class="row">
                        ...
                        <?php if($this->session->level == 'Karyawan'): ?>
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label for="divisi">Prodi : </label>
                                    <select name="divisi" id="divisi" value="<?= $karyawan->id_divisi ?>" class="form-control">
                                        <option value="" disabled selected>-- Pilih Prodi --</option>
                                        <?php foreach($id_divisi as $d): ?>
                                            <option value="<?= $d->id_divisi ?>" <?= ($d->id_divisi == $karyawan->id_divisi) ? 'selected' : '' ?>><?= $d->nama_divisi ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
