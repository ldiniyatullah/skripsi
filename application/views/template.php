...
<head>
    ...
    <title>Absensi UNIDA GONTOR</title>
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="../assets/img/sidebar-5.jpg" data-color="hitam">
            
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/unida.png') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2021 <a href="http://unida.gontor.ac.id">UNIDA Gontor</a>
                        </p>
                    </nav>
                </div>
            </footer>
