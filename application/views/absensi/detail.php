                    ...
                    <div class="col-xs-12 col-sm-6">
                        <table class="table border-0">
                            ...
                            <tr>
                                ...
                                <th class="border-0 py-0">:</th>
                                <th class="border-0 py-0"><?= $karyawan->email ?></th>
                            </tr>
                            <tr>
                                <th class="border-0 py-0">NIY/NIDN</th>
                                <th class="border-0 py-0">:</th>
                    ...
                    <tbody>
                        <?php if($absen): ?>
                            <?php foreach($hari as $i => $h): ?>
                                ...
                                ?>
                                <tr <?= (in_array($h['hari'], [ 'Jum\'at'])) ? 'class="bg-dark text-white"' : '' ?> <?= ($absen_harian == '') ? 'class="bg-danger text-white"' : '' ?>>
                                    <td><?= ($i+1) ?></td>
                                    <td><?= $h['hari'] . ', ' . $h['tgl'] ?></td>
